...
sudo_users = {SUDO,1366055467,944353237,9292929292,0303030030,0909090909}   
...
redis:sadd(bot_id..'DRAGON:Num:User:Pv',v) 
end
...
local list = redis:smembers(bot_id..'DRAGON:Num:User:Pv')  
local t = '{"users":['  
for k,v in pairs(list) do
if k == 1 then
t =  t..'"'..v..'"'
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Bandaa2/DG/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 🎯 اهلا بك في متجر ملفات سون بلص\n 🎯 ملفات السورس ↓\n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/Bandaa2/DG/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," 🎯 عذرا الملف لايدعم سورس سون بلص\n") 
end
return false
end
if text and text:match("^( ) (.*)(.lua)$") and DevSoFi(msg) then
...
local Text = [[  
اهلا في قائمه الالعاب المتطوره بوت سون بلص 🎮
...
if text == 'العاب متطوره' or text == 'العاب سون بلص' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'')
return false
end
...
{text = 'العاب السورس', callback_data="/help66"},{text = 'العاب متطوره', callback_data="/help55"},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
local Teext =[[
ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏụʀᴄᴇ ˢᵒᵒᶰ ᵖˡᵘˢ  ᴛᴏ 
ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴡɪᴛʜ ѕᴏụʀᴄᴇ ᴅᴇᴠᴇʟᴏᴘᴇʀѕ
🎯 [𝐒𝐎𝐎𝐍 𝐏𝐋𝐔𝐒](t.me/s_o_op)🎯 
]]
keyboard = {} 
keyboard.inline_keyboard = {
