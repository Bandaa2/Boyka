...
if res ~= 200 then
print('\27[0;31m═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
℘ ⦑ SOURCE DRAGON ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
🛡️ [Source Channel](t.me/S0DRG)
🛡️ [Source Update ](t.me/FIDRG)     
🛡️ [Source developer](t.me/s00f4)     
🛡️ [Dragon programmer](t.me/mndzr) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
