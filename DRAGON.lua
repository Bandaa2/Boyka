...
local NameUser = "🛡️بواسطه » ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "🛡️اسم المستخدم » ["..data.first_name_.."](T.me/"..UserName..")"
if status == "reply" then
send(msg.chat_id_, msg.id_,NameUserr.."\n"..text)
return false
end
else
send(msg.chat_id_, msg.id_,"🛡️الحساب محذوف يرجى استخدام الامر بصوره صحيحه")
end
end,nil)   
end 
...
send(chat,msg.id_,"* 🛡️عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")
end      
...
send(chat,msg.id_,"\n 🛡️تم رفع الملف بنجاح وتفعيل الجروبات\n 🛡️ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\n 🛡️العضــو » '..Name..'\n 🛡️قام بالتكرار هنا وتم طرده '  
...
Text = '\n 🛡️العضــو » '..Name..'\n 🛡️قام بالتكرار هنا وتم تقييده '  
sendText(msg.chat_id_,Text,0,'md')
return false  
end  
if type == 'mute' then
Text = '\n 🛡️العضــو » '..Name..'\n 🛡️قام بالتكرار هنا وتم كتمه '  
sendText(msg.chat_id_,Text,0,'md')
database:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_) 
msgm = msg.id_
my_ide = msg.sender_user_id_
...
send(msg.chat_id_, msg.id_," 🛡️تم الغاء الاذاعه")
...
send(msg.chat_id_, msg.id_," 🛡️تمت الاذاعه الى *~ "..#list.." ~* جروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 🛡️لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n  🛡️اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
local bl = '🛡️اهلا عزيزي آلمـطـور\n 🛡️آنت آلمـطـور آلآسـآسـي للبوت\n\═─── 𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═n 🛡️تسـتطـيع‌‏ آلتحگم باوامر البوت\اص بك\n 🛡️قناة سورس البوت [اضغط هنا](t.me/s_o_op) '
local keyboard = {
{'الاحصائيات ☉'},
...
send(msg.sender_user_id_, msg.id_,' 🛡️تم ارسال رسالتك\n 🛡️سيتم رد في اقرب وقت')
tdcli_function ({ID = "ForwardMessages", chat_id_ = SUDO,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
local Text = ' 🛡️تم ارسال الملصق من ↓\n - '..Name
...
Text = '\n 🛡️تم تفعيل البوت الخدمي ' 
else
Text = '\n 🛡️بالتاكيد تم تفعيل البوت الخدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 🛡️تم تعطيل البوت الخدمي' 
else
Text = '\n 🛡️بالتاكيد تم تعطيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاء ☉' then   
send(msg.chat_id_, msg.id_,' 🛡️الغاء حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,' 🛡️تم حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'ضع كليشه ستارت ☉' and DevSoFi(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 🛡️ارسل لي الكليشه الان')
return false
end
if text == 'مسح كليشه ستارت ☉' and DevSoFi(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' 🛡️تم مسح كليشه ستارت')
end
...
os.execute('wget https://raw.githubusercontent.com/Bandaa2/Boyka/main/DRAGON.lua')
...
send(msg.chat_id_, msg.id_," 🛡️ارسل الان اذاعتك؟ \n 🛡️للخروج ارسل الغاء ")
return false
end 
...
send(msg.chat_id_, msg.id_," 🛡️ارسل لي التوجيه الان")
return false
end 
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'🛡️لا يوجد مشتركين وهميين في البوت \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'🛡️عدد المشتركين الان » ( '..#pv..' )\n🛡️تم ازالة » ( '..sendok..' ) من المشتركين\n🛡️ الان عدد المشتركين الحقيقي » ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'🛡️لا يوجد جروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n🛡️تم ازالة » { '..q..' } جروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n🛡️تم ازالة » {'..w..'} جروب لان البوت عضو'
end
...
send(msg.chat_id_,msg.id_," 🛡️عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")
return false 
end      
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n 🛡️العضو » ['..result.title_..'](t.me/'..(username or 's_o_op')..')'
status  = '\n 🛡️تم ترقيته مطور'
texts = usertext..status
else
texts = ' 🛡️لا يوجد حساب بهاذا المعرف'
end
...
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🛡️تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🛡️العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 's_o_op')..') \n 🛡️'..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text == 'الغاء' or text == 'الغاء ☉' then   
send(msg.chat_id_, msg.id_," 🛡️تم الغاء حفظ اسم البوت")
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
database:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, " 🛡️تم حفظ الاسم")
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء ☉' then   
send(msg.chat_id_, msg.id_," 🛡️تم الغاء الاذاعه للخاص")
...
send(msg.chat_id_, msg.id_," 🛡️تمت الاذاعه الى >>{"..#list.."} مشترك في البوت ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 🛡️تمت الاذاعه الى >>{"..#list.."} جروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 🛡️تمت الاذاعه الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_, " 🛡️تم الغاء الامر ")
...
send(msg.chat_id_, msg.id_, ' 🛡️المعرف لا يوجد فيه قناة')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, ' 🛡️عذا لا يمكنك وضع معرف حسابات في الاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' 🛡️عذا لا يمكنك وضع معرف جروب بالاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,' 🛡️البوت ادمن في القناة \n 🛡️تم تفعيل الاشتراك الاجباري في \n 🛡️ايدي القناة ('..data.id_..')\n 🛡️معرف القناة ([@'..data.type_.channel_.username_..'])')
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,' 🛡️عذرآ البوت ليس ادمن بالقناه ')
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,' 🛡️تم تغيير رسالة الاشتراك ')
end
...
send(msg.chat_id_, msg.id_,' 🛡️تم تغيير صورة الجروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 🛡️تم الغاء وضع الوصف")
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
https.request('https://api.telegram.org/bot'..token..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
send(msg.chat_id_, msg.id_,' 🛡️تم تغيير وصف الجروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 🛡️تم الغاء حفظ الترحيب")
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,' 🛡️تم حفظ ترحيب الجروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_," 🛡️تم الغاء حفظ الرابط")
...
send(msg.chat_id_,msg.id_," 🛡️تم حفظ الرابط بنجاح")
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
send(msg.chat_id_,0," 🛡️العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 🛡️["..DRAGON_Msg.."] \n")
else
send(msg.chat_id_,0," 🛡️العضو : {["..data.first_name_.."](T.ME/s_o_op)}\n 🛡️["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, " 🛡️عذرا » {[@"..data.username_.."]}\n 🛡️عذرا تم منع الملصق \n" ) 
else
send(msg.chat_id_,0, " 🛡️عذرا » {["..data.first_name_.."](T.ME/s_o_op)}\n 🛡️عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' 🛡️بالتأكيد تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 🛡️بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 🛡️تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
send(msg.chat_id_, msg.id_,' 🛡️بالتأكيد تم تعطيل الجروب')
else
sendText(msg.chat_id_,'\n 🛡️بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 🛡️تم تعطيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 🛡️تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 🛡️بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 🛡️تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' 🛡️تم تعيين عدد الاعضاء سيتم تفعيل الجروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
if text == 'تحديث السورس'  or text == 'تحديث السورس ☉' and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
send(msg.chat_id_, msg.id_, ' 🛡️حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSoFi(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 🛡️حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "مسح رساله الاشتراك ☉" and DevSoFi(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " 🛡️تم مسح رساله الاشتراك ")
return false  
end
...
send(msg.chat_id_, msg.id_," 🛡️الاشتراك الاجباري مفعل \n 🛡️على القناة » ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_," 🛡️اهلا عزيزي المطور \n 🛡️ارسل الان معرف قناتك")
end
return false  
end
...
send(msg.chat_id_, msg.id_, " 🛡️تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ☉" and DevSoFi(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 🛡️تم تفعيل الاشتراك الاجباري \n 🛡️على القناة » ["..addchusername.."]")
else
send(msg.chat_id_, msg.id_, " 🛡️لا يوجد قناة في الاشتراك الاجباري ")
end
return false  
end
if text == "تفعيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '🛡️تم تفعيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "تعطيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '🛡️تم تعطيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
send(msg.chat_id_, msg.id_, '🛡️تم كتم الاسم '..BlNe)
...
send(msg.chat_id_, msg.id_, '🛡️تم الغاء كتم الاسم '..delBn)
...
texts = "🛡️تم مسح الاسماء المكتومه "
send(msg.chat_id_, msg.id_, texts)
end
...
send(v.user_id_, msg.id_,' 🛡️ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if (data and data.code_ and data.code_ == 3) then 
send(v.user_id_, msg.id_,' 🛡️البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
if data and data.code_ and data.code_ == 400 and data.message_ == "USER_ADMIN_INVALID" then 
send(v.user_id_, msg.id_,' 🛡️عذرا لا استطيع طرد ادمنية الجروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(v.user_id_, msg.id_,' 🛡️تم طردك من الجروب') 
...
send(msg.chat_id_, msg.id_, '🛡️تم تعطيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_,'🛡️تم تعيين '..teh..' كتوحيد للمجموعه')
...
send(msg.chat_id_, msg.id_,'🛡️تم تعين  '..nump..' عدد الكتم')
...
send(msg.chat_id_, msg.id_, '🛡️تم تعطيل التوحيد')
...
send(msg.chat_id_, msg.id_, "🛡️عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "s_o_op")..")\n🛡️عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\n🛡️عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
send(msg.chat_id_, msg.id_, '🛡️تم تفعيل تنبيه الاسماء')
...
send(msg.chat_id_, msg.id_, '🛡️تم تعطيل تنبيه الاسماء')
...
send(msg.chat_id_, msg.id_, '🛡️تم تفعيل تنبيه المعرف')
...
send(msg.chat_id_, msg.id_, '🛡️تم تعطيل تنبيه المعرف')
...
send(msg.chat_id_, msg.id_, '🛡️تم تفعيل تنبيه الصور')
...
send(msg.chat_id_, msg.id_, '🛡️تم تعطيل تنبيه الصور')
...
send(msg.chat_id_, msg.id_,' 🛡️تم ازالة جميع الاوامر المضافه')  
end
end
...
send(msg.chat_id_, msg.id_,' 🛡️ارسل الامر القديم')  
return false
end
...
send(msg.chat_id_, msg.id_,' 🛡️ارسل الامر الذي قمت بوضعه بدلا عن القديم')  
return false
end
end
if text and database:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
database:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,' 🛡️ارسل الامر الجديد')  
...
send(msg.chat_id_, msg.id_,' 🛡️تم حفظ الامر')  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 🛡️بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 's_o_op')..') \n 🛡️تـم قفـل الدردشه ')
end,nil)   
...
Text = ' 🛡️تم تفعيل نسبه الحب'
database:del(bot_id..'Cick:lov'..msg.chat_id_)  
else
Text = ' 🛡️بالتاكيد تم تفعيل نسبه الحب'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 🛡️تم تعطيل نسبه الانوثه'
else
Text = '\n 🛡️بالتاكيد تم تعطيل نسبه الانوثه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل all' and CoSu(msg) then   
if database:get(bot_id..'Cick:all'..msg.chat_id_) then
Text = ' 🛡️تم تفعيل امر @all'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = ' 🛡️بالتاكيد تم تفعيل امر @all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' 🛡️تم قفل التكرار بالطرد')
elseif text == 'قفل التكرار' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'del')  
send(msg.chat_id_, msg.id_,' 🛡️تم قفل التكرار')
elseif text == 'قفل التكرار بالتقييد' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'keed')  
send(msg.chat_id_, msg.id_,' 🛡️تم قفل التكرار بالتقييد')
elseif text == 'قفل التكرار بالكتم' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'mute')  
send(msg.chat_id_, msg.id_,' 🛡️تم قفل التكرار بالكتم')
elseif text == 'فتح التكرار' and Mod(msg) then 
database:hdel(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood")  
send(msg.chat_id_, msg.id_,' 🛡️تم فتح التكرار')
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, " 🛡️لا يمكنك حظر المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 🛡️لا تسطيع حظر البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1366055467) then  
send(msg.chat_id_, msg.id_, " 🛡️لا تسطيع حظر مطور السورس عام")
return false 
end
...
send(msg.chat_id_, msg.id_, " 🛡️لا يمكنك حظر مطور السورس \n")
return false 
end
usertext = '\n 🛡️العضو » ['..result.title_..'](t.me/'..(username or 's_o_op')..')'
status  = '\n 🛡️تم حظره عام من الجروبات'
texts = usertext..status
...
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, " 🛡️لا يمكنك كتم المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 🛡️لا تسطيع كتم البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1366055467) then  
send(msg.chat_id_, msg.id_, " 🛡️لا تسطيع كتم مطور السورس عام")
return false 
end
...
if result.id_ == tonumber(1366055467) then
send(msg.chat_id_, msg.id_, " 🛡️لا يمكنك كتم مطور السورس \n")
return false 
end
usertext = '\n 🛡️العضو » ['..result.title_..'](t.me/'..(username or 's_o_op')..')'
status  = '\n 🛡️تم كتمه عام من الجروبات'
...
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🛡️تم الغاء (الحظر-الكتم) عام من الجروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Get_info then
local TextS = "\n 🛡️اهلا بك في متجر ملفات باور\n 🛡️ملفات السورس ↓\n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n\n"
local TextE = "\n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n 🛡️علامة تعني { ✔️ } ملف مفعل\n 🛡️علامة تعني { ✖ } ملف معطل\n 🛡️قناة سورس باور ↓\n".." 🛡️[اضغط هنا لدخول](t.me/s_o_op) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 🛡️لا يوجد اتصال من ال api \n") 
end
return false
end
end
...
send(msg.chat_id_, msg.id_," 🛡️عذرا الملف لايدعم سورس باور \n") 
end
return false
end
if text and text:match("^( ) (.*)(.lua)$") and DevSoFi(msg) then
...
send(msg.chat_id_,msg.id_," 🛡️تم مسح الملفات")
return false
end
...
send(msg.chat_id_, msg.id_,' 🛡️لا ����ستطيع استخدام البوت \n  🛡️يرجى الاشتراك بالقناه اولا \n  🛡️اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
function start_function(extra, result, success)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🛡️تم تنزيله من الادمنيه العامين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if #list == 0 then
t = " 🛡️لا يوجد احد في قائمه المالك"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
t = "🛡️المنشئين الاساسين تعالو مخرب \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = "🛡️ماكو منششئين يشوفولك جاره"
end
Reply_Status(msg,msg.sender_user_id_,"reply","🛡️قام بنشر ملصق اباحيه\n"..t)  
...
Reply_Status(msg,msg.sender_user_id_,"reply","🛡️قام بنشر صوره اباحيه\n"..t)  
DeleteMessage(msg.chat_id_,{[0] = tonumber(msg.id_),msg.id_})   
end   
end
...
Text = ' 🛡️بالتاكيد تم تفعيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_, '\n 🛡️تم مسح المنشئين الاساسين')
return false
end
if text == 'المنشئين الاساسين' and CoSu(msg) then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n 🛡️قائمة المنشئين الاساسين \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
send(msg.chat_id_, msg.id_," 🛡️حساب المنشئ محذوف")
return false  
end
local UserName = (b.username_ or "ahmedyad200")
send(msg.chat_id_, msg.id_," 🛡️منشئ الجروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
Reply_Status(msg,result.sender_user_id_,"reply","🛡️تم ترقيته مطور اساسي في البوت")  
end
...
Reply_Status(msg,result.id_,"reply","🛡️تم ترقيته مطور اساسي في البوت")  
else
send(msg.chat_id_, msg.id_,"🛡️لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","🛡️تم ترقيته مطور اساسي في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","🛡️تم تنزيله من المطور اساسيين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","🛡️تم تنزيله من المطور اساسيين")  
else
send(msg.chat_id_, msg.id_,"🛡️لا يوجد حساب بهاذا المعرف")
end
end
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," 🛡️لا يوجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_," 🛡️تمت ترقيه { "..num2.." } من الادمنيه") 
end
end,nil)   
end
if text == 'مسح الادمنيه' and Manager(msg) then
database:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🛡️تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,' 🛡️تم تعطيل الرفع') 
return false
end
...
send(msg.chat_id_, msg.id_, ' 🛡️تم مسح المنظفين')
end
...
send(msg.chat_id_, msg.id_,' 🛡️تم تعطيل الطرد') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 🛡️لا تسطيع طرد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 🛡️عذرا لا تستطيع طرد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 🛡️البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
...
send(msg.chat_id_, msg.id_, '\n 🛡️عذرا لا تستطيع طرد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠| عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, '\n 🛡️عذرا لا تستطيع طرد ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 🛡️ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 🛡️البوت ليس ادمن يرجى ترقيتي !') 
...
send(msg.chat_id_, msg.id_, ' 🛡️تم مسح المميزين')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n 🛡️قائمة مميزين الجروب \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🛡️لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🛡️تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🛡️العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' 🛡️تم مسح جميع المطايه')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 🛡️تم رفع العضو مطي في الجروب \n 🛡️تعال حبي استلم العربانه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🛡️تم تنزيل العضو مطي في الجروب\n 🛡️تعال حبي رجع العربانه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 🛡️تم مسح جميع المتزوجين')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 🛡️تم زواجكم بنجاح في الجروب \n 🛡️الطلاق امتي عشان ابقي موجود '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🛡️تم طلاقكم بنجاح في الجروب\n 🛡️اوجعو تاني ونبي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 🛡️تم مسح كل الخولات')
end
...
if #list == 0 then
t = " 🛡️مع الاسف لا يوجد خولات غيرك هنا"
end
send(msg.chat_id_, msg.id_, t)
end
---------
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 🛡️تم رفع العضــو خول في الجروب \n 🛡️خد يخول يبن المره الغداره'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🛡️تم تنزيل العضــو الخول من الجروب\n 🛡️ارفعو تاني لحسن ارفعك مكانو'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 🛡️تم تنزيل جميع صخوله من الجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 🛡️تم رفع المتهم صخل بالجروب\n 🛡️الان اصبح صخل الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 🛡️تم مسج كل كلاب الجروب')
end
...
send(msg.chat_id_, msg.id_, ' 🛡️تم تنزيل جميع القروده بالجروب')
end
if text == ("تاك للقروده") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 🛡️قائمة القروده الجروب \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 🛡️تم رفع قرد في الجروب\n 🛡️تعال حبي استلم موزه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 🛡️تم رفع ضلع في الجروب\n 🛡️تعال حبيبي انت صرت من الضلوع حظر روحك منا ورايح نطلع سفرات للجزيره والزوراء ونشرب عرك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🛡️تم تنزيل ضلع من الجروب\n 🛡️بعد لتراويني وجهك ياحقير وجيب فلوس الشرب'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 🛡️تم مسح كل النسوان بالجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 🛡️تم رفع مره في الجروب\n 🛡️ها صرتي من نسواني تعي ندخل'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🛡️تم تنزيل مره من الجروب\n 🛡️بتاعي غضبان عليكي ليوم الدين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 🛡️تم رفع العضو علي زبك في الجروب\n 🛡️تفضل ابدا نيك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 🛡️تم مسح كل الاكساس بالجروب')
end
...
send(msg.chat_id_, msg.id_, ' 🛡️تم تنزيل جميع البقرات بالجروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n 🛡️قائمة البقرات الجروب \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 🛡️تم رفع بقره في الجروب\n 🛡️ها يالهايشه تع احلبك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🛡️تم تنزيل بقره من الجروب\n 🛡️تعال هاك حليب مالتك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 🛡️تم تنزيل جميع طليان بالجروب')
end
if text == ("تاك للطليان") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n 🛡️قائمة الطليان الجروب \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 🛡️تم رفع الطلي في الجروب\n 🛡️طلع برا ابو البعرور الوصخ'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 🛡️تم مسح كل الحكاكين')
end
if text == ("تاك للحكاكين") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 🛡️قائمة حكاكين الجروب \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🛡️تم تنزيل حكاك من الجروب\n 🛡️لا يسطت هيفضل حكاك رسمي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 🛡️تم تنزيل جميع جريزي')
end
if text == ("تاك للخنازير") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n 🛡️قائمة خنازير الجروب \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 🛡️تم رفع خنزير في الجروب\n 🛡️يديني امشي اطلع برا يمعفن'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 🛡️تم تعطيل الحظر') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 🛡️لا تسطيع حظر البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 🛡️عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if result.id_ then
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 🛡️عذرا لا تستطيع حظر ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 🛡️عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 🛡️عذرا لا تستطيع حظر ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 🛡️ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, ' 🛡️انا لست محظورآ \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, ' 🛡️تم مسح المكتومين')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 🛡️لا تسطيع كتم البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 🛡️عذرا لا تستطيع كتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 🛡️البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 🛡️عذرا لا تستطيع كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 🛡️عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🛡️تم كتم لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 🛡️عذرا لا تستطيع كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 🛡️البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 🛡️لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 🛡️عذرا لا تستطيع تقيد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 🛡️عذرا لا تستطيع تقيد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🛡️تم تقيده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n 🛡️عذرا لا تستطيع تقيد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n ​🛡️الايدي » `'..result.sender_user_id_..'`\n 🛡️ تم رفعه مشرف بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
...
if text == 'العاب سون بلص' or text == 'العاب خارقه' or text == 'العاب متطوره' then  
local Text = [[  
اهلا في قائمه الالعاب المتطوره بوت سون بلص 🕹️
...
keyboard.inline_keyboard = {
{
{text = 'اوامر الوضع', callback_data="/game1"},{text = 'اوامر التنزيل والرفع', callback_data="/game2"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '⌯ اوامر الوضع ⌯', callback_data="/game"},{text = 'اوامر التنزيل والرفع', callback_data="/game2"},
},
}
...
' }\n'..' 🛡️ الردود الجروب » { '..rdmder..
' }\n'..' 🛡️ الردود العامه » { '..rdsudo..
' }\n'..' 🛡️ الايدي » { '..idgp..
' }\n'..' 🛡️ الايدي بالصوره » { '..idph..
' }\n'..' 🛡️ الرفع » { '..setadd..
' }\n'..' 🛡️ الحظر » { '..banm..' }\n\n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n 🛡️قناة سورس باور ↓\n [🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙿𝙾𝚆𝙴𝚁.](t.me/s_o_op) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_," 🛡️عذرآ تم قفل التثبيت")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 🛡️تم تثبيت الرساله")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_," 🛡️انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_," 🛡️لا توجد رساله مثبته")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 🛡️ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
end
end,nil) 
end
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_," 🛡️عذرآ تم قفل الثبيت")  
return false  
end
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 🛡️تم الغاء تثبيت الرساله")   
...
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"🛡️تم الغاء تثبيت الكل")   
...
send(msg.chat_id_,msg.id_," 🛡️حسنآ ارسل اليه الرابط الان")
...
send(msg.chat_id_, msg.id_," 🛡️تم تفعيل الصوره") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 🛡️تم تعطيل الصوره") 
return false end
end
if text == "الرابط" then 
...
send(msg.chat_id_,msg.id_," 🛡️تم مسح الرابط")           
...
send(msg.chat_id_, msg.id_,' 🛡️ارسل لي الصوره') 
return false
end
...
send(msg.chat_id_, msg.id_,' 🛡️تم ازالة صورة الجروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' 🛡️ارسل الان الوصف')
end
return false  
end
...
t  = ' 🛡️ارسل لي الترحيب الان'
tt = '\n 🛡️تستطيع اضافة مايلي !\n 🛡️دالة عرض الاسم »{`name`}\n 🛡️دالة عرض المعرف »{`user`}'
...
GetWelcome = ' 🛡️لم يتم تعيين ترحيب للجروب'
end 
...
send(msg.chat_id_, msg.id_,' 🛡️تم تفعيل ترحيب الجروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' 🛡️تم تعطيل ترحيب الجروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'مسح الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 🛡️تم ازالة ترحيب الجروب') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_," 🛡️ارسل الكلمه لمنعها")  
...
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 🛡️ارسل التحذير عند ارسال الكلمه")  
...
if test == "repp" then  
send(msg.chat_id_, msg.id_," 🛡️تم منع الكلمه مع التحذير")  
...
send(msg.chat_id_, msg.id_," 🛡️تم مسح قائمه المنع")  
end
...
send(msg.chat_id_,msg.id_,' 🛡️تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'TEXT_SUDO',text)
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' 🛡️تم حفظ كليشة المطور')
return false
end
-----------------
...
send(msg.chat_id_, msg.id_, ' 🛡️تم ازالة كليشة الايدي')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 🛡️تم الغاء تعين الايدي") 
...
send(msg.chat_id_, msg.id_,' 🛡️تم تعين الايدي')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " 🛡️لا توجد بوتات في الجروب")
else
local t = ' 🛡️عدد البوتات هنا >> {'..c..'}\n 🛡️عدد البوتات التي هي ادمن >> {'..x..'}\n 🛡️تم طرد >> {'..(c - x)..'} من البوتات'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = '\n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n 🛡️عدد البوتات التي هنا >> {'..n..'} بوت\n'
local f = ' 🛡️عدد البوتات التي هي ادمن >> {'..t..'}\n 🛡️ملاحضه علامة ال (✯) تعني ان البوت ادمن \n'
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, " 🛡️تم الغاء حفظ القوانين") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_," 🛡️تم حفظ قوانين الجروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_," 🛡️ارسل لي القوانين الان")  
end
end
if text == 'مسح القوانين' or text == 'مسح القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_," 🛡️تم ازالة قوانين الجروب")  
...
send(msg.chat_id_, msg.id_," 🛡️لا توجد قوانين")   
end    
end
...
send(msg.chat_id_, msg.id_,' 🛡️تم طرد المحذوفين')
end,nil)
end
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,' 🛡️لا توجد صلاحيات مضافه')
return false
end
t = "\n 🛡️قائمة الصلاحيات المضافه \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_, " 🛡️ارسل نوع الرتبه \n 🛡️{عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
send(msg.chat_id_, msg.id_, "* 🛡️تم مسح الصلاحيه *\n") 
end
...
if text == 'مدير' then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_"* 🛡️تستطيع اضافه صلاحيات {ادمن - مميز - عضو} \n 🛡️ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_,"* 🛡️تستطيع اضافه صلاحيات {مميز - عضو} \n 🛡️ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
...
send(msg.chat_id_, msg.id_, " 🛡️تـم اضـافـه الامـر") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🛡️العضو » ['..result.title_..'](t.me/'..(text1[3] or 's_o_op')..')'..'\n 🛡️تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,' 🛡️تم مسح رسائلك'  )  
...
send(msg.chat_id_, msg.id_,' 🛡️عدد رسائلك » { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if num > 1500 then 
send(msg.chat_id_, msg.id_,'⚙️تستطيع المسح 1500 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,'🛡️تم مسح {'..num..'}')  
...
send(msg.chat_id_, msg.id_,"🛡️تم مسح جميع الميديا")
end
...
local Message = v
if Message then
t = "🛡️تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."S00F4:allM"..msg.chat_id_)
end
end
if #list == 0 then
t = "🛡️لا يوجد ميديا في المجموعه"
end
send(msg.chat_id_, msg.id_, t)
end
...
local numl = v
if numl then
l = "🛡️عدد الميديا الموجود هو "..k
end
end
if #num == 0 then
l = "🛡️لا يوجد ميديا في المجموعه"
end
...
send(msg.chat_id_, msg.id_,'🛡️تم مسح جميع الرسائل المعدله')
end
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," 🛡️ارسل لي الاسم الان ")  
end
return false
end
...
send(msg.chat_id_, msg.id_,' 🛡️الاذاعه معطله من قبل المطور الاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 🛡️ليست لدي صلاحية تغير اسم الجروب")  
else
sebd(msg.chat_id_,msg.id_,' 🛡️تم تغيير اسم الجروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_,"🛡️لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n🛡️تم تنزيل الشخص من الرتب التاليه \n🛡️ { "..dev..""..crr..""..cr..""..own..""..mod..""..mn..""..vip.." } \n")
else
...
send(msg.chat_id_, msg.id_," 🛡️تم مسح الردود العامه")
end

if text == ("الردود العامه") and DevSoFi(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n 🛡️قائمة الردود العامه \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' 🛡️ارسل الرد الذي تريد اضافته')
...
send(msg.chat_id_, msg.id_,' 🛡️تم ازالة الرد العام')
...
send(msg.chat_id_, msg.id_,' 🛡️ارسل الكلمه تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 🛡️ارسل الكلمه تريد مسحها')
...
send(msg.chat_id_, msg.id_,"🛡️تم مسح الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_," 🛡️تم مسح الردود الجروب")
end

if text == ("الردود الجروب") and Manager(msg) then
local list = database:smembers(bot_id..'List:Manager'..msg.chat_id_..'')
text = " 🛡️قائمه الردود الجروب \n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' 🛡️تم ازالة الرد ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,' 🛡️ارسل الكلمه التي تريد مسحها')
...
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 🛡️البوت ليس مشرف يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🛡️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
...
send(msg.chat_id_, msg.id_,' 🛡️تم مغادرة الجروب') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
Text = ' 🛡️تم تفعيل مغادرة البوت'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = ' 🛡️بالتاكيد تم تفعيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and DevSoFi(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = ' 🛡️تم تعطيل مغادرة البوت'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = ' 🛡️بالتاكيد تم تعطيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n 🛡️تم تعطيل الردود الجروب' 
else
Text = '\n 🛡️بالتاكيد تم تعطيل الردود الجروب'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 🛡️تم تفعيل الردود العامه' 
else
Text = '\n 🛡️بالتاكيد تم تفعيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 🛡️تم تعطيل الردود العامه' 
else
Text = '\n 🛡️بالتاكيد تم تعطيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 🛡️تم تفعيل الايدي بالصور' 
else
Text = '\n 🛡️بالتاكيد تم تفعيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 🛡️تم تعطيل الايدي بالصوره' 
else
Text = '\n 🛡️بالتاكيد تم تعطيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' 🛡️ايديه ~⪼ '..iduser..'\n 🛡️معرفه ~⪼ '..username..'\n 🛡️رتبته ~⪼ '..rtp..'\n 🛡️تعديلاته ~⪼ '..edit..'\n 🛡️نقاطه ~⪼ '..NUMPGAME..'\n 🛡️جهاته ~⪼ '..Contact..'\n 🛡️رسائله ~⪼ '..Msguser..'')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' 🛡️رتبتك في البوت » '..rtp)
end
if text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
if result.first_name_  then
first_name = ' 🛡️اسمك الاول » {`'..(result.first_name_)..'`}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' 🛡️اسمك الثاني » {`'..result.last_name_..'`}' 
else
last_name = ''
end      
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' 🛡️ايديك » '..msg.sender_user_id_)
end
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_," 🛡️البوت ليس ادمن \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
local sofi = ' 🛡️عدد الادمنيه : '..data.administrator_count_..
'\n\n 🛡️عدد المطرودين : '..data.kicked_count_..
'\n\n 🛡️عدد الاعضاء : '..data.member_count_..
'\n\n 🛡️عدد رسائل الجروب : '..(msg.id_/2097152/0.5)..
...
send(msg.chat_id_, msg.id_, '\n 🛡️عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
...
if data and data.code_ and data.code_ == 400 and data.message_ == "USER_ADMIN_INVALID" then 
send(msg.chat_id_, msg.id_,' 🛡️عذرا لا استطيع طرد ادمنية الجروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' 🛡️تم طردك من الجروب') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,' 🛡️تم تعطيل امر اطردني') 
end
end
...
send(msg.chat_id_, msg.id_,' 🛡️المعرف غلط ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,' 🛡️لا استطيع اصيح معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' 🛡️لا استطيع اصيح معرف بوتات') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,' 🛡️تعال حبي يصيحونك بل جروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' 🛡️تم تعطيل امر صيح') 
end
return false
end
...
send(msg.chat_id_, msg.id_,' 🛡️انت منشئ الجروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 🛡️الشخص الذي قام باضافتك هو » '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 🛡️انت دخلت عبر الرابط لتلح') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' 🛡️تم تعطيل امر ضافني') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = ' 🛡️تم تفعيل امر منو ضافني'
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' 🛡️بالتاكيد تم تفعيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 🛡️تم تعطيل امر منو ضافني'
else
Text = '\n 🛡️بالتاكيد تم تعطيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' 🛡️تم تفعيل امر صيح'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' 🛡️بالتاكيد تم تفعيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🛡️تم تنزيل الكل من الرتب الاتيه \n 🛡️المميزين ، الادمنيه ، المدراء ، المنشئين \n')
end
...
Text = '\n 🛡️بالتاكيد تم تعطيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = ' 🛡️تم تفعيل امر اطردني'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 🛡️بالتاكيد تم تفعيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 🛡️تم تعطيل امر اطردني'
else
Text = '\n 🛡️بالتاكيد تم تعطيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," 🛡️الصوره معطله") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 🛡️عدد صورك ~⪼ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
...
send(msg.chat_id_, msg.id_,'🛡️تم تغير الايدي ارسل ايدي لرؤيته')
end
...
local rtpg = rtpa
local sofia = {
" 🛡️اروح فـدوه للـحلوين",
" 🛡️حلوة حبيبي معليك بالمضغوطين",
" 🛡️جهرتك منورة ",
" 🛡️هاي شكد حلو انتة",
" 🛡️اصلا صوفي احلئ",
" 🛡️اصلا روظي احلئ",
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, sofi.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n 🛡️ايديك ~⪼ '..msg.sender_user_id_..'\n 🛡️معرفك ~⪼ '..username..'\n 🛡️رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 🛡️موقعك ~⪼ '..rtpa..'\n 🛡️تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n 🛡️رسائلك ~⪼ '..Msguser..'\n 🛡️نسبه تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n 🛡️السحكات ~⪼ '..edit..'\n 🛡️نقاطك ~⪼ '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n 🛡️ايديك ~⪼ '..msg.sender_user_id_..'\n 🛡️معرفك ~⪼ '..username..'\n 🛡️رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 🛡️موقعك ~⪼ '..rtpa..'\n 🛡️تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n 🛡️رسائلك ~⪼ '..Msguser..'\n 🛡️نسبه  تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n 🛡️السحكات ~⪼ '..edit..'\n 🛡️نقاطك ~⪼ '..NUMPGAME..']\n')
else
send(msg.chat_id_, msg.id_, '\n 🛡️الصوره ~⪼ ليس لديك صور في حسابك'..'[\n 🛡️ايديك ~⪼ '..msg.sender_user_id_..'\n 🛡️معرفك ~⪼ '..username..'\n 🛡️رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 🛡️موقعك ~⪼ '..rtpa..'\n 🛡️تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n 🛡️رسائلك ~⪼ '..Msguser..'\n 🛡️نسبه تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n 🛡️السحكات ~⪼ '..edit..'\n 🛡️نقاطك ~⪼ '..NUMPGAME..']\n')
end 
end
end
else
...
Text = ' 🛡️عدد سحكاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "مسح سحكاتي" or text == "مسح سحكاتي" then  
send(msg.chat_id_, msg.id_,' 🛡️تم مسح سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "مسح جهاتي" then  
send(msg.chat_id_, msg.id_,' 🛡️تم مسح جهاتك'  )  
...
send(msg.chat_id_, msg.id_,' 🛡️عدد الجروبات الان » { '..#group..' }'..DRAGONk..''..DRAGON..'\n*- الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
-- vardump(data) 
DRAGONdx(msg.chat_id_, msg.id_, ' 🛡️ايدي المجموعة » ( '..msg.chat_id_..' )\n 🛡️عدد الادمنيه » ( *'..data.administrator_count_..' )*\n 🛡️عدد المحظورين » ( *'..data.kicked_count_..' )*\n 🛡️عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_," 🛡️تم اضافة له {"..numadded..'} من الرسائل')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 🛡️ارسل لي عدد الرسائل الان') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 🛡️ارسل لي عدد النقاط التي تريد اضافتها') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_," 🛡️تم اضافة له {"..Num..'} من النقاط')  
end
...
if Num == 0 then 
Text = ' 🛡️لم تلعب اي لعبه للحصول على نقاط'
else
Text = ' 🛡️عدد نقاطك التي ربحتها هيه *» { '..Num..' } نقاط *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n* 🛡️لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,' 🛡️ليس لديك نقاط في الالعاب\n 🛡️اذا كنت تريد ربح نقاط \n 🛡️ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n 🛡️ليس لديك نقاط في هذه لعبه \n 🛡️لزيادة نقاطك في اللعبه \n 🛡️ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,' 🛡️تم خصم *» { '..NUMPY..' }* من نقاطك \n 🛡️وتم اضافة* » { '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\n 🛡️اهلا عزيزي البوت هنا ادمن'..'\n 🛡️وصلاحياته هي ↓ \nٴ━━━━━━━━━━'..'\n 🛡️تغير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n 🛡️مسح الرسائل ↞ ❴ '..delete..' ❵'..'\n 🛡️حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n 🛡️دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n 🛡️تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n 🛡️اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
send(msg.chat_id_, msg.id_," 🛡️تم تغير رد المطور الى » "..Teext)
end
...
{
{text = '𓆩𝐒𝐎𝐎𝐍 𝐏𝐋𝐔𝐒𓆪', url="t.me/s_o_op"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local text = 'تم ايجاد العضو اضغط هنا ⚙️'
...
send(msg.chat_id_, msg.id_,' 🛡️تم مسح الامر')  
else
send(msg.chat_id_, msg.id_,' 🛡️لا يوجد امر بهاذا الاسم')  
end
...
send(msg.chat_id_, msg.id_, ' 🛡️تم تعطيل اوامر التسليه')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التسليه") then 
send(msg.chat_id_, msg.id_, '  🛡️تم تفعيل اوامر التسليه')
...
send(msg.chat_id_,0,''..t..'\n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n 🛡️تم التعديل على الميديا\n 🛡️الشخص الي قام بالتعديل\n 🛡️ايدي الشخص ◂ '..result.sender_user_id_..'\n 🛡️معرف الشخص»{ '..users..' }') 
end,nil)
